...
Err MsFrameScoretronProcessormatic::init(
    ...
    e = ErrorUtils::isNotEmpty(scoreVectorsFilePath); ree;
    e = ErrorUtils::isNotEmpty(msFrameScansFilePath); ree;
...
Err MsFrameScoretronProcessormatic::buildFrameIndexVsScanPoints(
...
//        }
//
//        qDebug() << peptideScores.size() << peptideScores.front();
//    }
//
//    ERR_RETURN
//}

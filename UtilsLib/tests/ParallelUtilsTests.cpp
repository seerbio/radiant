...
private Q_SLOTS:
    void tranchVectorForParallelizationTest();
    void tranchVectorForParallelizationInOrderTest();
...
void ParallelUtilsTests::tranchVectorForParallelizationTest()
{
    ERR_INIT
    ...
    e = ParallelUtils::tranchVectorForParallelization(m_testData, 3, &output);
    QCOMPARE(e, eNoError);
    ...
    e = ParallelUtils::tranchVectorForParallelization(m_testData, 2, &output2);
    QCOMPARE(e, eNoError);
...
void ParallelUtilsTests::tranchVectorForParallelizationInOrderTest() {

    ERR_INIT

    QVector<QVector<int>> output;
    e = ParallelUtils::tranchVectorForParallelizationInOrder(m_testData2, 12, 0, &output);
    QCOMPARE(e, eNoError);
    QCOMPARE(output.size(), m_testData2.size());

    e = ParallelUtils::tranchVectorForParallelizationInOrder(m_testData2, 3, 0, &output);
    QCOMPARE(e, eNoError);
    ...
    e = ParallelUtils::tranchVectorForParallelizationInOrder(m_testData2, 3, 2, &output);
    QCOMPARE(e, eNoError);
    ...
    e = ParallelUtils::tranchVectorForParallelizationInOrder(truncData, 8, 1, &output);
    QCOMPARE(e, eNoError);
...
//    e = ParallelUtils::tranchVectorForParallelizationInOrder(bigger, 8, 1, &output);
//    QCOMPARE(e, eNoError);
//    qDebug() << "SDFDS" << output;

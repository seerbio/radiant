...
CREATE TABLE Frames (
    ...
    -- Maximum intensity occurring in the data belonging to this spectrum (can quickly generate a
    -- BPC from this). This value describes the line data (if present), otherwise the profile data
    ...
    -- generate a TIC from this). Compare 'MaxIntensity' column.

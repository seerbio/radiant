...
void EigenUtilsTests::linearRegressionTest() {
    ...
    QCOMPARE(e, eNoError);
    QCOMPARE(qFuzzyCompare(slope , -8.75826e-05f), true);
    QCOMPARE(qFuzzyCompare(intercept , 1.1442f), true);
    QCOMPARE(qFuzzyCompare(stdErr , 0.000253926f), true);
    QCOMPARE(qFuzzyCompare(pValue , 0.730159f), true);

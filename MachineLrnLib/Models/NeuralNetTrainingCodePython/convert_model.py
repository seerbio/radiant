...
def main(in_path1, out_path1, no_tests1=False):
    convert(in_path1, out_path1, no_tests1)


if __name__ == "__main__":

    """
    python convert_model.py C:/Repositories/PyCharm/MSMS_RNN/Models/rnn_linear_charge_1.hdf5 C:/Repositories/PyCharm/MSMS_RNN/Models/rnn_linear_charge_1.hdf5.json
    """
    ...
    main(in_path, out_path, no_tests)

...
void PlayGroundTests::testme() {
    ...
    const QString fragLibFilepath = QStringLiteral("/home/ubuntu/Downloads/diann.format.speclib");
	const QString fastaFile = "/home/ubuntu/Downloads/human_plasma_arath_entrapment.fasta";
    const QString msDataFilepath = QStringLiteral("/home/ubuntu/Downloads/EXP24078_2024EU0002rX3_A.raw.mzML");
	const QString configFile = "/home/ubuntu/Data/pythia-config.pythiaConfig";
	...
	e = pythiaDiaFFWorkflow.processFile(msDataFilepath);
	QCOMPARE(e, eNoError);

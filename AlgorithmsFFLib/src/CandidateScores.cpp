...
QVector<float> CandidateScores::selectFeaturesArrayFeatures(const QVector<Features> &enumFeatures) const {
    return selectFeaturesArrayFeatures(featuresArray, enumFeatures);
}

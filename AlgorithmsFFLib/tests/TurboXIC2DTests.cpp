...
class TurboXIC2DTests : public QObject
{
    Q_OBJECT

public:
    TurboXIC2DTests() = default;
    ~TurboXIC2DTests() override = default;
...
QMap<int, QVector<PointFF>> TurboXIC2DTests::buildPoints() const {
...
void TurboXIC2DTests::extractPointsTest() {
    ...
    const XICPoints xicPoints = turboXIC.extractPointsXIC(100.0, 100.13, 1.0, 5.0);
...
void TurboXIC2DTests::turboXICUtility() {
...
QTEST_MAIN(TurboXIC2DTests)
#include "TurboXIC2DTests.moc"
